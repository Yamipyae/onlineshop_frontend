                    ...
                    decoration: BoxDecoration(
                     ...
                     child: TextButton(
                      onPressed:(){
                        ...
                        addItems(nameContoller.text, imgUrlController.text, price, stock);
                        
                         setState(() {
                           Provider.of<CartModel>(context,listen: false).addProduct(nameContoller.text, imgUrlController.text, price, stock);
                         });
