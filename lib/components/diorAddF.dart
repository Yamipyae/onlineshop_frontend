...
class diorAddPage extends StatefulWidget {
  const diorAddPage({super.key});

  @override
  State<diorAddPage> createState() => _diorAddPageState();
}

class _diorAddPageState extends State<diorAddPage> {
                     ...
                     child: TextButton(
                      onPressed:(){
                        ...
                        int stock = int.parse(stockController.text);
                         DiorAddF(nameContoller.text, imgUrlController.text, price, stock);
                         setState(() {
                           Provider.of<CartModel>(context,listen: false).addDior(nameContoller.text, imgUrlController.text, price, stock);
                         });
